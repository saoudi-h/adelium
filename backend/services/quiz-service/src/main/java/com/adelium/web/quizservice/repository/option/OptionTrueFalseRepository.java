...
@Repository
@Transactional
@RepositoryRestResource(collectionResourceRel = "optionTrueFalses", path = "option-true-falses")
public interface OptionTrueFalseRepository extends BaseRepository<OptionTrueFalse, Long> {}
